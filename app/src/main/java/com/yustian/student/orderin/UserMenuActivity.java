...
public class UserMenuActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, ListView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(UserMenuActivity.this, UserOrderActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent intent = new Intent(UserMenuActivity.this, UserTableActivity.class);
            startActivity(intent);
    ...
    private void showContact(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                UserMenuActivity.this, list, R.layout.activity_user_list_view,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(UserMenuActivity.this,"Menyiapkan Menu","Silahkan Tunggu",false,false);
            }
            @Override
